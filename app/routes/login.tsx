        ...
        <Layout>
            <div className="h-full justify-center items-center flex flex-col gap-y-4">
                ...
                <form method="post" className="rounded-2xl bg-gray-200 p-6 w-96">
                    ...
                    <input autoComplete="true" type="text" id="email" name="email" className="w-full p-2 rounded-xl my-2" />

                    <label htmlFor="password" className="text-blue-600 font-semibold">
                        Password
                    </label>
                    <input autoComplete="true" type="password" id="password" name="password" className="w-full p-2 rounded-xl my-2" />
