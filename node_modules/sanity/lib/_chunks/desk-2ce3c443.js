...
const TitleCard = styled__default.default(ui.Card)(_ref14 => {
  let {
    theme
  } = _ref14;
  const {
...
const TabsBox = styled__default.default(ui.Box)(_ref15 => {
  let {
    theme
  } = _ref15;
  const {
      ...
      children: /* @__PURE__ */jsxRuntime.jsx(sanity.LegacyLayerProvider, {
        ...
        children: /* @__PURE__ */jsxRuntime.jsxs(ui.Card, {
          ...
          children: [/* @__PURE__ */jsxRuntime.jsxs(Layout, {
            ...
            sizing: "border",
            style: layoutStyle,
            children: [backButton, /* @__PURE__ */jsxRuntime.jsxs(TitleCard, {
              __unstable_focusRing: true,
              flex: 1,
              forwardedAs: "button",
...
const PaneHeaderActions = React.memo(_ref20 => {
  let {
...
const deskTool = sanity.definePlugin(options => ({
  ...
  tools: [{
    ...
    component: React.lazy(() => Promise.resolve().then(function () {
      return require('./index-672f28d4.js');
    }).then(function (n) {
      return n.index;
    })),
...
//# sourceMappingURL=desk-2ce3c443.js.map
