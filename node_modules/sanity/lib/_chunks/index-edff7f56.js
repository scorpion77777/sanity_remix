...
var desk = require('./desk-2ce3c443.js');
var index = require('./index-672f28d4.js');
var PathUtils = require('@sanity/util/paths');
var types = require('@sanity/types');
var sanity = require('sanity');
var PaneItem = require('./PaneItem-9d33e83f.js');
...
function DocumentListPaneContent(props) {
  ...
  const mainContent = React.useMemo(() => {
    ...
    if (loadingVariant === "initial" && isLoading) {
      return /* @__PURE__ */jsxRuntime.jsx(index.Delay, {
        ms: 300,
    ...
    const key = "".concat(index$1, "-").concat(collapsed);
  ...
  }, [collapsed, error, handleEndReached, index$1, isLoading, items, layout, loadingVariant,
  // noDocumentsContent,
...
//# sourceMappingURL=index-edff7f56.js.map
